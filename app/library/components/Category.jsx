            ...
            <div>
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <div className="w-[162px] h-[42px] flex justify-between items-center p-4 bg-neutral-800 border border-neutral-600 rounded-3xl text-[14px] cursor-pointer">
                            <div>최근 활동</div>
                            <div>
                    ...
                    <DropdownMenuContent
                        className="w-[360px] bg-neutral-800"
                        align="end"
                    >
